...
# model.save(r'E:\zyy\cnnlstm\testmodel1.h5')
# np.save(r'E:\zyy\cnnlstm\trainloss_tmd1.npy',train_loss)
# np.save(r'E:\zyy\cnnlstm\val_loss_tmd1.npy',val_loss)

# model = keras.models.load_model(r'E:\zyy\cnnlstm\testmodel1.h5')
