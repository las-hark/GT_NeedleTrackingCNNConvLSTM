...
model1 = keras.models.load_model(r'E:\zyy\cnnlstm\light_model03.h5')
...
# reg = l2(0.001)
model = Sequential()
model.add(TimeDistributed(SeparableConv2D(filters     = 8,
                                        kernel_size = k_size,
                                        activation  = 'relu',
...
model.add(TimeDistributed(MaxPooling2D(2)))
model.add(TimeDistributed(SeparableConv2D(filters     = 16,
                                        kernel_size = k_size,
                                        activation  = 'relu',
                                        padding     = 'same')))
...
model.save(r'E:\zyy\cnnlstm\light_model02.h5')
np.save(r'E:\zyy\cnnlstm\trainloss_lt2.npy',train_loss)
np.save(r'E:\zyy\cnnlstm\val_loss_lt2.npy',val_loss)

model = keras.models.load_model(r'E:\zyy\cnnlstm\light_model02.h5')
